...
{  
    ...
    File folder = new File(userDirectoryPath + "/xml_logs");
  ...
  outputData.add(new String[] { "Recognition Log: Sheela Ippili  // $1 algorithm // medium dataset for all users in xml_logs// USER-DEPENDENT RANDOM 10"," "," "," "," "," "," "," "," "," "," "," "," " });
    ...
    for (int e = 1; e<=9; e++){
        ...
        for (int i=0; i<10; i++){
            ...
            for (Unistroke eachCandidate : candidateTemplates){
                ...
                int isCorrect = 0;
                String matchedGesture = BestScorename.substring(0, BestScorename.length()-2);
